...
window.exports.require = function (id, callback) {
  ...
  var errorHandler = function (e) {
    ...
    callback(
      null,
      new Error("The script '" + e.target.src + "' failed to load."),
    );
  };
...
window.addEventListener("error", function (event) {
  var error =
    event instanceof ErrorEvent && event.error && event.error instanceof Error
      ? event.error
      : new Error(
